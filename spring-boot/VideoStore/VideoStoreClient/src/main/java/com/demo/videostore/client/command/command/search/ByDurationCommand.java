...
@CommandLine.Command(
        name = "duration",
        description = "Search by file duration"
)
public class ByDurationCommand implements Runnable {
    ...
    public void run() {
        ...
        Call<List<Metadata>> callSync = service.searchByDuration(from, to);
        ...
        try {
            ...
            System.out.println("SearchByDurationCommand exception: " + e.getMessage());
        }
    }
}
